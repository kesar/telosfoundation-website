...
const faqs = [
	{
		...
		answer: [
			...
			'You will also be able to access TLOS tokens with Sqrl, the wallet of the Telos Blockchain Network Blockchain. Scatter and DEXEOS will be listing a TLOS/EOS pair, Chainrift will list a  TLOS/BTC pair, and more exchanges are expected to announce their support as well.',
	...
	},
	{
		...
		answer: [
			'EOS and Telos are both networks running the EOSIO software. Any smart contract that runs on one system should run equally well on the other. Telos Blockchain Networkhas modified the EOS genesis snapshot and some rules to make the network more responsible to the majority of token holders, to be more attractive to DApp developers, and to generally run more responsibly and sustainably.'
		]
	},
	{
		question: 'What is TLOS?',
		answer: [
			'TLOS is the name of the token that reflects ownership in the Telos Blockchain Network. A TLOS token is like an EOS token except that there will be around 3X fewer TLOS tokens than EOS.'
		]
	},
	{
	...
	{
		question: 'What is the difference between the Telos Blockchain Network launch and activation?',
		answer: [
			'Telos Blockchain Network launch is the process of beginning to run the Telos Blockchain Network to allow votes to be cast for block producers and for network validation. Activation is the point when TLOS holders can begin transferring or otherwise controlling their tokens beyond just voting.'
		]
	},
	{
		question: 'If exchange addresses cannot vote, will my TLOS tokens be able to vote if they are currently on an exchange?',
		answer: [
			'Once tokens are off the exchange and on your own Telos Blockchain Network address, you can vote them. Individual owners cannot vote their tokens held on exchanges. Preventing voting from exchange accounts keeps exchanges from voting with customer tokens, which is against the Telos Blockchain Network rules.'
		]
	},
	{
		question: 'Will this hurt the EOS network?',
		answer: [
			'The EOS network will succeed or fail based on its own merits. We hope it succeeds, as we are all deeply invested in this project. However, the EOS mainnet release has revealed problems with the system that will be difficult to resolve on the EOS blockchain. “Whales” have shown that they generally just vote for their own block producer partners and even game the rewards system to harm other block producers— this may also be expected once worker proposals emerge. The EOS network is under the control of a few whale accounts. We offer a fresh approach where all token holders’ voices matter. Telos Blockchain Network also hopes to provide a testbed for new ideas that may eventually be adopted by the EOS mainnet. In this way we hope to strengthen EOS.'
		]
	},
	{
		question: 'If these changes will fix the network, why doesn’t EOS make them?',
		answer: [
			'Block.one sold EOS tokens in their tokensale. They accepted money for tokens and made certain representations. They can’t easily change the results of their sale—especially by reducing the tokens of their largest contributors, which is really the key change that fixes the system. Telos Blockchain Network is a completely new system that never took money from nor made promises to anyone. We intend to build a network using the open source EOS software (that we all helped pay for) to create an entirely new network that better represents the true purpose of EOS.'
		]
	},
	{
		question: 'Can I buy and sell TLOS tokens? What are they worth?',
		answer: [
			'TLOS tokens will not gain value until the Telos Blockchain Network mainnet launches and they are able to be traded. In practical terms, TLOS will gain real value when exchanges accept them to trade against other cryptocurrencies. We expect that this will happen because exchange customers will demand that they be given access to their tokens. The technical requirements for listing TLOS will be identical to EOS so we expect little resistance on that point. Once tokens are freely trading on exchanges they will find their value based on supply and demand. The TLOS token supply will be between one-fifth and one-third that of EOS, and the Telos Blockchain Network should be as good as or better than EOS. Telos Blockchain Network will also not have any “whale” addresses which often are responsible for price manipulations in other coins.'
		]
	},
	{
	...
	{
		question: 'Who are you and why are you launching Telos Blockchain Network?',
		answer: [
	...
	},
	{
		...
		answer: [
			'Absolutely! We hope they will since they know how to run EOSIO nodes well. Anyone who meets the minimum requirements for a Telos Blockchain Network block producer may submit themselves for voting.'
		]
	},
	{
	...
	},
	{
		...
		answer: [
			'Each smart contract will designate if portions of its code are proprietary. Telos Blockchain Network members will be able to choose whether or not they wish to work with proprietary smart contracts or only open source contracts.'
		]
	},
	{
		question: 'How are Telos Blockchain Network block producers paid?',
		answer: [
			'Telos Blockchain Network will have 21 ABPs and up to 30 standby block producers sharing the 1% TLOS inflation. Each block producer will be paid the same flat rate and each standby will be one half of that rate. All will receive pay deductions for missed blocks.'
		]
	},
	{
		question: 'Will the team launching Telos Blockchain Network take a fee for its service?',
		answer: [
			'Launching the Telos Blockchain Network is an expensive and time-consuming venture. The people launching Telos Blockchain Network include block producers, developers, social media marketers, arbitrators, and others working together in a largely decentralized way. Members of the Telos Blockchain Network Launch Group will be compensated in the TLOS genesis file. A Telos Founders Reward Pool (TFRP) will be created in the Telos Blockchain Network genesis file containing 6M TLOS (about 1.8% of the expected money supply). This fund will be distributed among members of the Telos Launch Group – an open-membership group established to create and launch the Telos Blockchain Network – based on tasks performed by members. The exact method of TFRP distribution is yet to be determined but will be formalized prior to network launch.'
		]
	},
	{
			...
			<Grid>
				<Row>
					<Col md={10} mdOffset={1}>
						...
						<h2>These FAQs do not provide legal advice and are for educational purposes only. You can find more information on our <a href='https://github.com/Telos-Foundation' target='_blank' rel='noopener noreferrer'>GitHub</a> repository and <a href='https://medium.com/@teloslogical' target='_blank' rel='noopener noreferrer'>Medium</a> page.</h2>
					</Col>
				</Row>
			</Grid>
		</section>
